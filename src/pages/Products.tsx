        ...
        <div className="flex gap-8">
          ...
          <div className="hidden md:block w-72 flex-shrink-0">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24 backdrop-blur-lg bg-opacity-90">
              ...
              <div className="relative w-full md:w-96 py-4">
                ...
                <input
                  ...
                  className="w-50 pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-300 transition-all duration-200 bg-gray-50 hover:bg-white"
                />
              </div>
                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            className="w-5 h-5 rounded-lg border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                          />
          ...
          <div className="flex-1">
            {filteredProducts.length > 0 ? (
              ...
              <div className="text-center py-16 bg-white rounded-2xl shadow-lg">
                ...
                <button
                  onClick={clearAllFilters}
                  className="px-8 py-3 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors duration-200 shadow-md hover:shadow-lg font-medium"
                >
                  Clear all filters
                </button>
              </div>
        ...
        <div className="fixed inset-0 right-36 z-50 md:hidden">
          ...
          <div className="absolute inset-y-0 right-0 w-full max-w-sm bg-white shadow-2xl transform transition-transform duration-300">
              ...
              <div className="space-y-8">
                ...
                <div className="relative w-full md:w-96">
                  ...
                  <input
                    ...
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-[200px] pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-300 transition-all duration-200 bg-gray-50 hover:bg-white"
                  />
                </div>
                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            checked={selectedCategories.includes(category)}
                            onChange={() => handleCategoryChange(category)}
                            className="w-6 h-6 rounded-lg border-2 border-gray-300 text-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all duration-200"
                          />
                          {selectedCategories.includes(category) && (
            ...
            <div className="border-t p-6">
              <button
                onClick={() => setShowFilters(false)}
                className="w-full bg-blue-600 text-white py-4 rounded-xl hover:bg-blue-700 transition-colors duration-200 shadow-md hover:shadow-lg font-medium text-lg"
              >
                Apply Filters
              </button>
            </div>
