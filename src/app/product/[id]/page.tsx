...
export default function ProductDetailPage() {
  ...
  const getProductImages = (prod: typeof product) => {
    if (!prod) return [];
  ...
  const shuffledRelated = [...relatedProducts].sort(() => Math.random() - 0.5).slice(0, 4);
      ...
      <div className="pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            <button onClick={() => router.push('/products')} className="flex items-center text-gray-600 hover:text-gray-900">
          ...
          <div className="text-center py-16">
            ...
            <button onClick={() => router.push('/products')} className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
              Browse Products
            </button>
          </div>
        </div>
